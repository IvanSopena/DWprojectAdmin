...
<form id="movies_form" <?php if($titulo === "Añadir Nueva Pelicula"){echo "action='/DWprojectAdmin/add_movies'";}else{echo "action='/DWprojectAdmin/update_movies'";}?> method="POST" >
    <div class="row">
        <div class="col-lg-7">
            <div class="row">
                ...
                <div  class="col-sm-6 form-group">
                    <select name="st" class="form-control" id="exampleFormControlSelect2">
                    <?php 
                    if($titulo === "Añadir Nueva Pelicula"){
