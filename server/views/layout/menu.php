<div id="sidebar-scrollbar">
            <nav class="iq-sidebar-menu">
               <ul id="iq-sidebar-toggle" class="iq-menu">
                  ...
                  <li><a href="/DWprojectAdmin/comments" class="iq-waves-effect"><i class="fa fa-comments-o"></i><span>Comentarios</span></a></li> 
                  ...
                  <li>
                     ...
                     <ul id="category" class="iq-submenu collapse" data-parent="#iq-sidebar-toggle">
                        <li><a href="/DWprojectAdmin/add_category"><i class="fa fa-plus"></i>Añadir Categoria</a></li>
                        <li><a href="/DWprojectAdmin/view_category"><i class="fa fa-eye"></i>Listar Categorias</a></li>
                     </ul>
                  </li>
                  <li>
                  ...
                  <li>
                     <a href="#show" class="iq-waves-effect collapsed" data-toggle="collapse" aria-expanded="false"><i
                        class="ri-tv-line"></i><span>Series</span><i
